...
const devices: Device[] = [
  ...
  { id: '2', name: 'RFID Reader - Side Gate', location: 'Side Entrance', status: 'online', lastScan: '5 min ago', scansToday: 156, battery: 78 },
  { id: '3', name: 'RFID Reader - Staff Entry', location: 'Staff Building', status: 'online', lastScan: '1 min ago', scansToday: 89, battery: 95 },
  { id: '4', name: 'RFID Reader - Back Gate', location: 'Back Entrance', status: 'warning', lastScan: '45 min ago', scansToday: 23, battery: 15 },
  { id: '5', name: 'RFID Reader - Gym Entry', location: 'Sports Complex', status: 'offline', lastScan: '2 hours ago', scansToday: 67 },
];
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-3">
              <CheckCircle className="w-5 h-5 text-green-600" />
              <div>
                <p className="font-medium">Side Gate - Scan Successful</p>
          ...
          <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
            <div className="flex items-center gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-600" />
              <div>
                <p className="font-medium">Back Gate - Low Battery Warning</p>
