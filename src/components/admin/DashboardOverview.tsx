...
const attendanceData = [
  { date: 'Mon', present: 842, absent: 23 },
  { date: 'Tue', present: 856, absent: 22 },
  { date: 'Wed', present: 839, absent: 20 },
  { date: 'Thu', present: 863, absent: 19 },
  { date: 'Fri', present: 848, absent: 21 },
];
...
const realtimeActivity = [
  ...
  { id: '3', student: 'Sarah Johnson', action: 'Check-out', location: 'Exit', time: '5 min ago', status: 'success' },
  { id: '4', student: 'Michael Brown', action: 'Check-in', location: 'Main Gate', time: '7 min ago', status: 'success' },
