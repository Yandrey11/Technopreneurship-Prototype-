...
const recentReports: Report[] = [
  ...
  { id: '3', name: 'Student Attendance Details - All', type: 'Excel', date: 'Nov 3, 2024', size: '4.7 MB' },
  { id: '4', name: 'Daily Attendance Report - November 13', type: 'PDF', date: 'Nov 13, 2024', size: '1.5 MB' },
];
